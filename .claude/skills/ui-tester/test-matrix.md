...
| Limit reached | `status: limit_reached` | — (manual here; full 5-turn walkthrough automated in [T2 `/ui-functionality-multi-turn-limit`](../ui-functionality-multi-turn-limit/SKILL.md)) | Warning; baseline preserved |
