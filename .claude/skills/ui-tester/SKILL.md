...
- [Guided estimates](../ui-tester-guided-estimates/SKILL.md): single-drug, multiple-drug, compare-plans, combobox, reset, and submission flows.
- [Responsive interactions](../ui-tester-responsive-interactions/SKILL.md): viewport, keyboard, focus, overlay, touch, and safe-area verification.
