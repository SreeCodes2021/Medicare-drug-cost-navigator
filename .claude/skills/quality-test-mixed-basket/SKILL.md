...
- [numeric-accuracy/golden-cases.jsonl](../numeric-accuracy/golden-cases.jsonl) — `mixed_basket` group (`golden-048`–`050`)
- [docs/insulin-cost-estimation.md](../../../docs/insulin-cost-estimation.md) — insulin cap rules
- Related insulin-only pass: [insulin/SKILL.md](../quality-test-insulin/SKILL.md)
