...
| Invoke | Focus | Skill |
|--------|-------|-------|
| `/quality-test-no-false-signals` | Picker must not imply coverage | [no-false-signals/SKILL.md](../quality-test-no-false-signals/SKILL.md) |
| `/quality-test-disclaimer-compliance` | Disclaimer on every surface | [disclaimer-compliance/SKILL.md](../quality-test-disclaimer-compliance/SKILL.md) |
| `/quality-test-answer-consistency` | Oracle vs UI/chat prose | [answer-consistency/SKILL.md](../quality-test-answer-consistency/SKILL.md) |
| `/quality-test-insulin` | IRA insulin cap billing — deterministic + 10 LLM (insulin-only) | [insulin/SKILL.md](../quality-test-insulin/SKILL.md) |
| `/quality-test-mixed-basket` | Insulin + regular same-plan baskets — deterministic + 20 LLM | [mixed-basket/SKILL.md](../quality-test-mixed-basket/SKILL.md) |
| `/quality-test-pharmacy-lookup` | ZIP-based pharmacy locator (Q1/Q2/Q3 chat routing, ZIP edge cases) — deterministic pytest + 33 LLM scenarios / 34 queries (customizable via `--limit`) | [pharmacy-lookup/SKILL.md](../quality-test-pharmacy-lookup/SKILL.md) |
...
| Invoke | Skill | Phase |
|--------|-------|-------|
| `/quality-test-no-false-signals` | [no-false-signals/SKILL.md](../quality-test-no-false-signals/SKILL.md) | § 1c-A only |
| `/quality-test-disclaimer-compliance` | [disclaimer-compliance/SKILL.md](../quality-test-disclaimer-compliance/SKILL.md) | § 1c-A + dim 4 on live turns |
| `/quality-test-answer-consistency` | [answer-consistency/SKILL.md](../quality-test-answer-consistency/SKILL.md) | § 1c-A + § 1c-B |
...
Full policy: [answer-consistency/SKILL.md](../quality-test-answer-consistency/SKILL.md).
...
documented in [`chat-qa`](../chat-qa/SKILL.md) needs AR-ingested live data.
...
Scenario 2 is also graded per [`chat-qa`](../chat-qa/SKILL.md) dimension 1
...
[mixed-basket/llm-scenarios.md](../quality-test-mixed-basket/llm-scenarios.md).
...
[`/functional-test` § 6](../functional-test/SKILL.md) via
[`ui-functionality/multi-turn-limit`](../ui-functionality-multi-turn-limit/SKILL.md) —
...
Grade each turn with the [`chat-qa`](../chat-qa/SKILL.md) rubric (at minimum
dimension 1 grounding and the "did not break" check from
[`exploratory-qa`](../exploratory-qa/SKILL.md)); a single BLOCK turn anywhere in a
...
| Mixed insulin + regular same-plan basket | [`mixed-basket/llm-scenarios.md`](../quality-test-mixed-basket/llm-scenarios.md) or parent §2g |
...
- **Misleading-case sub-skills (§ 1c):**
  - [no-false-signals/SKILL.md](../quality-test-no-false-signals/SKILL.md)
  - [disclaimer-compliance/SKILL.md](../quality-test-disclaimer-compliance/SKILL.md)
  - [answer-consistency/SKILL.md](../quality-test-answer-consistency/SKILL.md)
  - [mixed-basket/SKILL.md](../quality-test-mixed-basket/SKILL.md)
