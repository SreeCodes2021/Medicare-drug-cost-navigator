...
description: >-
  ...
  60-query cap and insulin-only /quality-test/insulin budget.
...
Parent `/quality-test` also runs **2 mandatory §2g queries** (subset of this catalog) within its 60-query cap.
