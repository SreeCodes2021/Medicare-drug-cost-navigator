...
description: >-
  ...
  /quality-test 60-query budget. Mixed insulin+regular baskets: /quality-test/mixed-basket.
...
`/quality-test` 60-query budget — run it separately after a general quality
