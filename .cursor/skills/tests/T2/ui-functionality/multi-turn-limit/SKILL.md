...
[`/quality-test` § 2i](../../../T3/SKILL.md#2i-multi-turn-conversation-depth-mandatory--30-queries-every-run).
...
5. Repeat steps 1–4 for the **Guided** flow's shared `guidedSessionId` (see
   [state-carryover/SKILL.md](../state-carryover/SKILL.md) step 3 for how the guided
