...
hand off chat-quality issues to [`/chat-QA`](../../utils/chat-QA/SKILL.md).
...
For **end-to-end portal flows** (Playwright + guided API smoke), use [`/ui-functionality`](../../T2/ui-functionality/SKILL.md).

For a single call that runs this skill plus the field/keyboard sweep and responsive checklist together, use [`/smoke-test`](../SKILL.md).
...
| Skill | When |
|-------|------|
| [`/chat-QA`](../../utils/chat-QA/SKILL.md) | Assistant text quality, citations, compliance |
| [`/chat-bot-fixer`](../../../chat-bot-fixer/SKILL.md) | Implement pipeline fixes from chat-QA |
| [`/ui-functionality`](../../T2/ui-functionality/SKILL.md) | E2E portal flows (chat, guided surfaces) |
